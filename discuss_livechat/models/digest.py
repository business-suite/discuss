...
class Digest(models.Model):
    ...
    def _compute_kpi_livechat_response_value(self):
        for record in self:
            start, end, company = record._get_kpi_compute_parameters()
            response_time = self.env['discuss_livechat.report.operator'].sudo().read_group([
    ...
    def _compute_kpis_actions(self, company, user):
        ...
        res['kpi_livechat_rating'] = 'discuss_livechat.rating_rating_action_livechat_report'
        res['kpi_livechat_conversations'] = 'discuss_livechat.discuss_livechat_report_operator_action'
        res['kpi_livechat_response'] = 'discuss_livechat.discuss_livechat_report_channel_time_to_answer_action'
        return res
