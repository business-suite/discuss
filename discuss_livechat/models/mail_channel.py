...
class MailChannel(models.Model):
    ...
    livechat_channel_id = fields.Many2one('discuss_livechat.channel', 'Channel')
    ...
    def execute_command_history(self, **kwargs):
        self.env['bus.bus']._sendone(self.uuid, 'discuss_livechat.history_command', {'id': self.id})
    ...
    def _email_livechat_transcript(self, email):
        ...
        template = self.env.ref('discuss_livechat.livechat_email_template')
