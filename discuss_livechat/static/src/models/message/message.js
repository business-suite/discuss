...
registerClassPatchModel('mail.message', 'discuss_livechat/static/src/models/message/message.js', {
    /**
     * @override
     */
    convertData(data) {
...
registerInstancePatchModel('mail.message', 'discuss_livechat/static/src/models/message/message.js', {
