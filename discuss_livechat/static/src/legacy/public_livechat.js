odoo.define('discuss_livechat.legacy.discuss_livechat.discuss_livechat', function (require) {
"use strict";
...
var WebsiteLivechat = require('discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechat');
var WebsiteLivechatMessage = require('discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechatMessage');
var WebsiteLivechatWindow = require('discuss_livechat.legacy.discuss_livechat.WebsiteLivechatWindow');

var _t = core._t;
var QWeb = core.qweb;

// Constants
var LIVECHAT_COOKIE_HISTORY = 'discuss_livechat_history';
...
var LivechatButton = Widget.extend({
    ...
    async willStart() {
        var cookie = utils.get_cookie('discuss_livechat_session');
        if (cookie) {
            ...
            const result = await session.rpc('/discuss_livechat/init', {channel_id: this.options.channel_id});
    ...
    start: function () {
        ...
        if (this._history) {
            ...
            var autoPopupCookie = utils.get_cookie('discuss_livechat_auto_popup');
    ...
    _closeChat: function () {
        ...
        utils.set_cookie('discuss_livechat_session', "", -1); // remove cookie
    },
    /**
     * @private
    ...
    _handleNotification: function ({ payload, type }) {
        switch (type) {
            case 'discuss_livechat.history_command': {
                ...
                session.rpc('/discuss_livechat/history', {
    ...
    _loadQWebTemplate: function () {
        return session.rpc('/discuss_livechat/load_templates').then(function (templates) {
    ...
    _openChat: _.debounce(function () {
        ...
        if (cookie) {
            ...
            def = session.rpc('/discuss_livechat/get_session', {
        ...
        def.then(function (livechatData) {
            if (!livechatData || !livechatData.operator_pid) {
                ...
                return self._openChatWindow().then(function () {
                    ...
                    utils.set_cookie('discuss_livechat_session', utils.unaccent(JSON.stringify(self._livechat.toData()), true), 60 * 60);
                    utils.set_cookie('discuss_livechat_auto_popup', JSON.stringify(false), 60 * 60);
                    if (livechatData.operator_pid[0]) {
                        ...
                        utils.set_cookie('discuss_livechat_previous_operator_pid', operatorPidId, oneWeek);
                    }
                });
            }
        }).then(function () {
     ...
     *
     * The information is stored in the 'discuss_livechat_previous_operator_pid' cookie.
     *
     * @private
     * @return {integer} operator_id.partner_id.id if the cookie is set
     */
    _get_previous_operator_id: function () {
        var cookie = utils.get_cookie('discuss_livechat_previous_operator_pid');
        if (cookie) {
            return cookie;
        }
    ...
    _onSaveChatWindow: function (ev) {
        ev.stopPropagation();
        utils.set_cookie('discuss_livechat_session', utils.unaccent(JSON.stringify(this._livechat.toData()), true), 60 * 60);
    },
    /**
     * @private
     * @param {OdooEvent} ev
    ...
    _visitorLeaveSession: function () {
        ...
        if (cookie) {
            var channel = JSON.parse(cookie);
            session.rpc('/discuss_livechat/visitor_leave_session', {uuid: channel.uuid});
            utils.set_cookie('discuss_livechat_session', "", -1); // remove cookie
        }
    },
});
...
var Feedback = Widget.extend({
    template: 'discuss_livechat.legacy.discuss_livechat.FeedBack',
    ...
    /**
     * @param {?} parent
     * @param {discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechat} livechat
     */
    ...
    _sendFeedback: function (reason) {
        ...
        this.dp.add(session.rpc('/discuss_livechat/feedback', args)).then(function (response) {
    ...
    */
    _onEmailChat: function () {
        ...
        if (utils.is_email($email.val())) {
            ...
            this._rpc({
                route: '/discuss_livechat/email_livechat_transcript',
                params: {
                    uuid: this._livechat.getUUID(),
                    email: $email.val(),
                }
...
odoo.define('discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechat', function (require) {
"use strict";

var AbstractThread = require('discuss_livechat.legacy.mail.model.AbstractThread');
var ThreadTypingMixin = require('discuss_livechat.legacy.mail.model.ThreadTypingMixin');
...
var WebsiteLivechat = AbstractThread.extend(ThreadTypingMixin, {
     ...
     * @param {discuss_livechat.legacy.discuss_livechat.discuss_livechat:LivechatButton} params.parent
     */
    ...
    /**
     * @override
     * @returns {discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechatMessage[]}
     */
     ...
     *
     * @param {discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechatMessage[]} messages
     */
    ...
    _notifyMyselfTyping: function (params) {
        return session.rpc('/discuss_livechat/notify_typing', {
            uuid: this.getUUID(),
...
odoo.define('discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechatMessage', function (require) {
"use strict";

var AbstractMessage = require('discuss_livechat.legacy.mail.model.AbstractMessage');

/**
 * This is a message that is handled by discuss_livechat, without making use of the
 * mail.Manager. The purpose of this is to make discuss_livechat compatible with
 * mail.widget.Thread.
 *
 * @see discuss_livechat.legacy.mail.model.AbstractMessage for more information.
 */
var WebsiteLivechatMessage = AbstractMessage.extend({

    /**
     * @param {discuss_livechat.legacy.discuss_livechat.discuss_livechat.LivechatButton} parent
     * @param {Object} data
     * @param {Object} options
...
odoo.define('discuss_livechat.legacy.discuss_livechat.WebsiteLivechatWindow', function (require) {
"use strict";

var AbstractThreadWindow = require('discuss_livechat.legacy.mail.AbstractThreadWindow');

/**
 * This is the widget that represent windows of livechat in the frontend.
 *
 * @see discuss_livechat.legacy.mail.AbstractThreadWindow for more information
 */
var LivechatWindow = AbstractThreadWindow.extend({
     ...
     * @override
     * @param {discuss_livechat.legacy.discuss_livechat.discuss_livechat:LivechatButton} parent
     * @param {discuss_livechat.legacy.discuss_livechat.model.WebsiteLivechat} thread
     * @param {Object} [options={}]
...
odoo.define('discuss_livechat.legacy.mail.model.AbstractThread', function (require) {
"use strict";
...
var AbstractThread = Class.extend(Mixins.EventDispatcherMixin, {
     ...
     *
     * @param {discuss_livechat.legacy.mail.model.AbstractMessage} message
     */
    ...
    /**
     * @abstract
     * @returns {discuss_livechat.legacy.mail.model.AbstractMessage[]}
     */
    getMessages: function () {},
    /**
     ...
     * @see {discuss_livechat.legacy.mail.model.ThreadSeenMixin} to enable this feature on a thread.
     *
     * @returns {boolean}
     */
...
odoo.define('discuss_livechat.legacy.mail.model.ThreadTypingMixin', function (require) {
"use strict";

var CCThrottleFunction = require('discuss_livechat.legacy.mail.model.CCThrottleFunction');
var Timer = require('discuss_livechat.legacy.mail.model.Timer');
var Timers = require('discuss_livechat.legacy.mail.model.Timers');
...
odoo.define('discuss_livechat.legacy.mail.model.AbstractMessage', function (require) {
"use strict";
 ...
 * The purpose of this interface is to make discuss_livechat compatible with
 * mail.widget.Thread, as this widget was designed to work with messages that
 * are instances of mail.model.Messages.
 *
 * Ideally, discuss_livechat should also handle mail.model.Message, but this is not
...
odoo.define('discuss_livechat.legacy.mail.AbstractThreadWindow', function (require) {
"use strict";

var ThreadWidget = require('discuss_livechat.legacy.mail.widget.Thread');
...
var AbstractThreadWindow = Widget.extend({
    template: 'discuss_livechat.legacy.mail.AbstractThreadWindow',
    custom_events: {
     ...
     * @abstract
     * @param {Widget} parent
     * @param {discuss_livechat.legacy.mail.model.AbstractThread} [thread=null] the thread that this
     *   thread window is linked to. If not set, it is the "blank" thread
     *   window.
     * @param {Object} [options={}]
     * @param {discuss_livechat.legacy.mail.model.AbstractThread} [options.thread]
     */
    ...
    renderHeader: function () {
        ...
        this.$header.html(
            QWeb.render('discuss_livechat.legacy.mail.AbstractThreadWindow.HeaderContent', options));
    },
    /**
...
odoo.define('discuss_livechat.legacy.mail.model.CCThrottleFunctionObject', function (require) {
"use strict";
...
odoo.define('discuss_livechat.legacy.mail.model.CCThrottleFunction', function (require) {
"use strict";

var CCThrottleFunctionObject = require('discuss_livechat.legacy.mail.model.CCThrottleFunctionObject');
...
odoo.define('discuss_livechat.legacy.mail.model.Timer', function (require) {
"use strict";
...
odoo.define('discuss_livechat.legacy.mail.model.Timers', function (require) {
"use strict";
...
odoo.define('discuss_livechat.legacy.mail.widget.Thread', function (require) {
"use strict";

var DocumentViewer = require('discuss_livechat.legacy.mail.DocumentViewer');
var mailUtils = require('@mail/js/utils');
...
var ThreadWidget = Widget.extend({
    ...
    /**
     * @param {discuss_livechat.legacy.mail.model.AbstractThread} thread the thread to render.
     * @param {Object} [options]
    ...
    render: function (thread, options) {
        ...
        this.$el.html(QWeb.render('discuss_livechat.legacy.mail.widget.Thread', {
            thread: thread,
    ...
    renderLoading: function () {
        this.$el.html(QWeb.render('discuss_livechat.legacy.mail.widget.ThreadLoading'));
    },
    ...
    */
     ...
     *
     * @private
     * @param {discuss_livechat.legacy.mail.model.AbstractMessage[]} messages list of messages in the
    ...
    _renderMessageNotificationPopover(messages) {
        ...
        this._messageMailPopover = this.$('.o_thread_tooltip').popover({
            ...
            content: function () {
                ...
                return QWeb.render('discuss_livechat.legacy.mail.widget.Thread.Message.MailTooltip', {
     ...
     *
     * @private
     * @param {discuss_livechat.legacy.mail.model.AbstractThread} thread with thread seen mixin,
     *   @see {discuss_livechat.legacy.mail.model.ThreadSeenMixin}
     * @param {discuss_livechat.legacy.mail.model.Message[]} messages list of messages in the
     *   rendered thread.
     */
    _renderMessageSeenPopover: function (thread, messages) {
        ...
        this._messageSeenPopover = this.$('.o_thread_message_core .o_mail_thread_message_seen_icon').popover({
            ...
            content: function () {
                ...
                return QWeb.render('discuss_livechat.legacy.mail.widget.Thread.Message.SeenIconPopoverContent', {
                    thread: thread,
                    message: message,
                });
            },
...
odoo.define('discuss_livechat.legacy.mail.DocumentViewer', function (require) {
"use strict";
...
var DocumentViewer = Widget.extend({
    template: "discuss_livechat.legacy.mail.DocumentViewer",
    events: {
    ...
    _updateContent: function () {
        this.$('.o_viewer_content').html(QWeb.render('discuss_livechat.legacy.mail.DocumentViewer.Content', {
            widget: this
        }));
    ...
    _onPrint: function (e) {
        ...
        var script = QWeb.render('discuss_livechat.legacy.mail.PrintImage', {
            src: src
        });
