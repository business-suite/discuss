...
QUnit.module('discuss_livechat', {}, function () {
...
QUnit.test('do not add livechat in the sidebar on visitor opening his chat', async function (assert) {
    ...
    this.data['discuss_livechat.channel'].records.push({
        id: 10,
    ...
    await this.env.services.rpc({
        route: '/discuss_livechat/get_session',
        params: {
            context: {
                mockedUserId: false,
            },
...
QUnit.test('do not add livechat in the sidebar on visitor typing', async function (assert) {
    ...
    await this.env.services.rpc({
        route: '/discuss_livechat/notify_typing',
        params: {
            context: {
