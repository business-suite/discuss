...
patch(MockModels, 'discuss_livechat/static/tests/helpers/mock_models.js', {
    ...
    generateData() {
        ...
        Object.assign(data['mail.channel'].fields, {
            ...
            livechat_channel_id: { string: "Channel", type: 'many2one', relation: 'discuss_livechat.channel' },
