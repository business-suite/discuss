...
class TestGetMailChannel(TransactionCase):
    def setUp(self):
        ...
        self.livechat_channel = self.env['discuss_livechat.channel'].create({
            'name': 'The channel',
        ...
        self.patch(type(self.env['discuss_livechat.channel']), '_get_available_users', get_available_users)
