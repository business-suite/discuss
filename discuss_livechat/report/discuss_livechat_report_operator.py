...
class ImLivechatReportOperator(models.Model):
    ...
    _name = "discuss_livechat.report.operator"
    ...
    def init(self):
        ...
        tools.drop_view_if_exists(self.env.cr, 'discuss_livechat_report_operator')
        self.env.cr.execute("""
            CREATE OR REPLACE VIEW discuss_livechat_report_operator AS (
                SELECT
