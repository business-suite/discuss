...
Help your customers with this chat, and analyse their feedback.
        ...
        """,
    'data': [
        "security/discuss_livechat_channel_security.xml",
        "security/ir.model.access.csv",
        "data/mail_shortcode_data.xml",
        "data/mail_data.xml",
        "data/discuss_livechat_channel_data.xml",
        'data/digest_data.xml',
        "views/rating_views.xml",
        "views/mail_channel_views.xml",
        "views/discuss_livechat_channel_views.xml",
        "views/discuss_livechat_channel_templates.xml",
        "views/res_users_views.xml",
        "views/digest_views.xml",
        # "views/messaging_menu.xml",
        "report/discuss_livechat_report_channel_views.xml",
        "report/discuss_livechat_report_operator_views.xml"
    ],
    'demo': [
        "data/discuss_livechat_channel_demo.xml",
        'data/mail_shortcode_demo.xml',
    ],
    'depends': ["discuss", "rating", "digest"],
    'installable': True,
    'auto_install': False,
    'application': True,
    'assets': {
        'mail.assets_discuss_public': [
            'discuss_livechat/static/src/components/*/*',
            'discuss_livechat/static/src/models/*/*.js',
        ],
        'web.assets_backend': [
            'discuss_livechat/static/src/js/discuss_livechat_channel_form_view.js',
            'discuss_livechat/static/src/js/discuss_livechat_channel_form_controller.js',
            'discuss_livechat/static/src/components/*/*.js',
            'discuss_livechat/static/src/models/*/*.js',
            'discuss_livechat/static/src/scss/discuss_livechat_history.scss',
            'discuss_livechat/static/src/scss/discuss_livechat_form.scss',
        ],
        'web.qunit_suite_tests': [
            'discuss_livechat/static/src/components/*/tests/*.js',
            'discuss_livechat/static/src/legacy/public_livechat.js',
            'discuss_livechat/static/tests/helpers/mock_models.js',
            'discuss_livechat/static/tests/helpers/mock_server.js',
        ],
        'web.assets_qweb': [
            'discuss_livechat/static/src/components/*/*.xml',
        ],
        # Bundle of External Librairies of the Livechat (Odoo + required modules)
        'discuss_livechat.external_lib': [
            # Momentjs
            ...
            'discuss_livechat/static/src/js/ajax_external.js',
            ...
            'discuss_livechat/static/src/scss/discuss_livechat_bootstrap.scss',
            'discuss_livechat/static/src/legacy/public_livechat.scss',
        ]
    },
    'license': 'LGPL-3',
}
